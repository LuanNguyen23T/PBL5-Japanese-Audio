...
export function LockUserDialog({ isOpen, user, onClose, onConfirm }: LockUserDialogProps) {
 ...
 >
 <option value="Vi phạm chính sách bảo mật / Hoạt động bất thường">Vi phạm chính sách bảo mật / Hoạt động bất thường</option>
 <option value="Spam hoặc Lạm dụng hệ thống">Spam hoặc Lạm dụng hệ thống</option>
 <option value="Ngôn từ kích động hoặc Xúc phạm cá nhân">Ngôn từ kích động hoặc Xúc phạm cá nhân</option>
 <option value="Vi phạm bản quyền tài liệu">Vi phạm bản quyền tài liệu</option>
 <option value="Sử dụng phần mềm thứ ba trái phép">Sử dụng phần mềm thứ ba trái phép</option>
 <option value="Yêu cầu từ Chủ sở hữu tài khoản / Tạm khóa bảo vệ">Yêu cầu từ Chủ sở hữu tài khoản / Tạm khóa bảo vệ</option>
 </select>
 </div>
 <div>
 <label className="block text-sm font-medium text-muted-foreground mb-2">
