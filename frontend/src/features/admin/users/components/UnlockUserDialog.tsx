...
export function UnlockUserDialog({ isOpen, user, onClose, onConfirm }: UnlockUserDialogProps) {
 ...
 Bạn có chắc chắn muốn mở khoá tài khoản <strong className="text-foreground">{user.email}</strong>? Người dùng sẽ ngay lập tức được khôi phục toàn bộ quyền truy cập vào hệ thống.
 </p>
